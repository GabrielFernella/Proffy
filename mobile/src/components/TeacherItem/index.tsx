...
function TeacherItem (){
   ...
   return( 
      <View style={styles.container} >
         ...
         <Text style={styles.bio}>Biografia Biografia Biografia Biografia Biografia Biografia Biografia 
            BiografiaBiografiaBiografia Biografia Biografia Biografia Biografia
         </Text>
